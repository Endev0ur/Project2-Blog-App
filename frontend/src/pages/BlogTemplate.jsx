...
const BlogTemplate = ({blog}) => {
  ...
  return (
    <div className='lg:h-[50%] lg:w-[45%]   2xl:h-[50%] 2xl:w-[30%] bg-amber-500 mt-10 m-5 2xl:m-3 rounded-2xl flex justify-around items-center flex-wrap border-3 opacity-100'>
